...
import "./katalogOsnovnoy.css";
import ReactPaginate from "react-paginate";
import CardSkeleton from "../../glavnaya/CardSkeleton";
import Modal from "../../glavnaya/module";
import { useSelector,useDispatch } from "react-redux";
import { increment,setLength,decrement,setValue } from "../../../store/actions/zakladkiAction";
import AwesomeSlider from "react-awesome-slider";

export default function KatalogOsnovnoy(link){
  ...
  const push = (item,item2) =>{ 
    navigate(`/katalog/city=${item2}/${item}`)
  }
  ...
  },[itemOffset,KatalogPerPage,link,sort])
