...
import errorPage from "../glavnaya/Oshibka"
import { Col,Row } from "react-bootstrap"
import ArendaRoom2 from "../glavnaya/ArendaRoom2";
import img7 from "../glavnaya/img/footer/8.svg"
import "./katalogselect.css"
import { useParams,useNavigate,Link} from "react-router-dom";
import axios from "../../axios";
import 'react-awesome-slider/dist/styles.css';
import AwesomeSlider from "react-awesome-slider";

export default function katalogselect(){
  ...
  return(
    ...
    <section className="firstKatalog">
      <div className="filterInfo">
          <div className="conteinerKatalogSelect">
            <div className="hlebnie">
            <nav className="breadcrumbs KatalogSelect" style={{display:"flex",alignItems:"center"}}>
              <Link to="/">
              ...
              <div className="HomeLink cirle" style={{margin:"0px 7px",paddingBottom:"5px"}}>
            ...
            <div className="allKatalogselect">
              <div className="textFilterInfo">
                <div className="ArendaInnerText ArendaInnerTextkatalogSelect">
    ...
    <img className="tochkiJeltie" style={{marginTop:"2%",position:"absolute",left:0,marginLeft:"21%"}} src={img7} alt="" />
        <div className="conteinerKatalogSelect">
          ...
          <AwesomeSlider  className="imgKatalogSelect">
            <img data-src={arenda.url} alt="" />
          </AwesomeSlider>
            <p className="opisanieKatalogSelect">{arenda.opisanie}</p>
          </div>
        </div>
    </section>
            ...
            <div className="Card">
              <div className="ColRowHome conteiner">
                <div className="cards" style={{display:"flex",justifyContent:"space-between"}}>
                  <Row>
                    <Col>
                      <ArendaRoom2>{"/ArendaCard"}</ArendaRoom2>
                    </Col>
                  </Row>
                </div>
              </div>
