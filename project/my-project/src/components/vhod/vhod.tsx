      ...
      <Formik 
        ...
        <Form className="Vhodforma">
          <div className="Osnovnoe">
            ...
            <div className={("OshibkaVvoda fix" && ((touched.login&&errors.login)||(touched.password && errors.password)||(values.login=="")||(values.password=="")))? "OshibkaVvoda fix":"OshibkaVvoda"}>
              <div className="">
