...
import { clearFilter, setCity, setFilterAll, setKvartiri } from "../../store/slices/FilterSlice";
import { changeInfo } from "../../store/actions/obyavleniaAction";
import { increment,setLength,decrement} from "../../store/actions/zakladkiAction";
...
const Header = () => {
  ...
  const lengthZakladki = useSelector((state:any) => state.zakladkiAction.length);
  const obyavlenieRedux = useSelector((state:any) => state.obyavleniaAction);
  ...
  const [zakladki,setZakladki] = useState<any>([]);
  ...
  const kvartiri = useSelector((state:any) => state.filter.kvartiri);
  ...
  const click3=()=>{
   ...
   const hover = () =>{
    document.querySelectorAll(".dropdown3").forEach(function(dropdownWrapper){
      const listitemclick=dropdownWrapper.querySelectorAll(".dropdown__item");
      const kvartiri = document.querySelector(".kvartiri");
      const btnclick = dropdownWrapper.querySelector(".Spisok__dropdown");
      btnclick.classList.add("Spisok__dropdown__visible");
      listitemclick.forEach(function(listitem){
        listitem.addEventListener("click",(e)=>{
          kvartiri.textContent=`Квартиры в ${cityIn(listitem.id)}`;
          ...
          //     checkboxInfo:filterFromHome.inputCheckboxInfo
          //   }))
          //   navigate(`/katalog/city=?${queryString}`)
          // }
          btnclick.classList.remove("Spisok__dropdown__visible");
        })
      })
  ...
  //  Появление шапки
  window.onscroll=() => {
    const header = document.querySelector(".VerhNav");
    if(window.pageYOffset > 95){
      header.classList.add("VerhNav__fixed")
    }
    else{
      header.classList.remove("VerhNav__fixed");
    }
  }
       ...
       <nav>
            ...
            <div className="VerhNav">
              <div className="leftpart" style={{display:"flex",alignItems:"center"}}>
                <NavLink to="/" className="item" onClick={()=>window.scroll(0,0)}>Главная</NavLink>
                <NavLink to="/News"className="item" onClick={()=>window.scroll(0,0)}>Новости</NavLink>
                <NavLink to="/123"className="item" onClick={()=>window.scroll(0,0)}>Размещение и тарифы</NavLink>
                <NavLink to="/Map"className="item" onClick={()=>window.scroll(0,0)}>
                ...
                <NavLink to="/kontakti"className="item" onClick={()=>window.scroll(0,0)}>Контакты</NavLink>
              </div>
              <div className="rightpart">
                  <NavLink to="/Zakladki"className="item item3" onClick={()=>window.scroll(0,0)}>
                    <span>Закладки</span>
                    ...
                    <div className="UserLink">
                      <div className="dropdown2">
                        ...
                        <ul className="Spisok__dropdown" >
                          ...
                          <li key={"change6"} className="dropdown__item"><Link to = "/obyavlenia" style={{textDecoration:"none",color:"#1e2123"}}>Мои объявления</Link></li>
                          <li key={"exit"} className="dropdown__item">Выйти</li>
                        </ul>
                        <input type="text" name="select__category" className="drodown__item__hiden" />
                      </div>
                    </div>
                    :<Link to="/Vhod"className="item item2" onClick={()=>window.scroll(0,0)}>Вход и регистрация </Link>
                }
              </div>
            </div>
          </div>
    ...
    <div className="conteiner">
          ...
          <Link to="/">
            ...
            <image id="image0_2831_2326" width="134" height="19" xlinkHref="data:image/png;base64,"/>
              ...
              <NavLink to={`/katalog/city=?`} onClick={()=>{dispatch(setKvartiri(""))}} className="Items" style={{marginRight:"39px",padding:0}}>
                <div className="dropdown3" onMouseEnter={hover} onMouseLeave={unhover}>
                  <div className="group Items" style={{marginRight:"0px"}}>
                    <p className="kvartiri">{kvartiri=="Квартиры на сутки"?kvartiri:`Квартиры в ${cityIn(gorod)}`}</p>
                  ...
                  <ul className="Spisok__dropdown" style={{marginTop:"2px"}}>
                    <>
                    {
                      Cities.map((item)=>{
                        return(
                          <div className="Items3">
                              <li key = {item.city+"2"} className="dropdown__item" id={item.city}>
          ...
          <button className="btndob" onClick={()=>login?setModalActive2(true):notify3()}>+ Разместить объявление</button>
          </div>
        </div>
        </div>
        ...
        <Modal active={modalActive} setActive={setModalActive}>
                ...
                <Form style={{width:"600px",display:"flex",justifyContent:"center",flexDirection:"column",alignItems:"center"}}>
                  ...
                  <div className="" style={{display:"flex",marginBottom:"25px"}}>
                    <div className="partOneObyavlenie" style={{marginRight:"15px"}}>
                      ...
                      <img style={{borderRadius:"145px"}} className="IconImgObyavlenie"src={imgUrlUser?imgUrlUser:userImg} alt="" />
                        <button style={{marginLeft:"59px"}} onClick={btnChoose3} className="Voyti choose" type="button">Выберите файл</button>
                      <Field id="file-input3" type="file" onChange={handleOnChange3} value={values.urlImg} style={{display:"none"}} />
                    </div>
            ...
            {/* forma redactirovania obyavlenia*/}
            ...
            <>
             ...
             <section className="FirstObyablenie">
              <div className="infoObyavlenie">
                ...
                <div className="exit">
                    <svg onClick={CloseModal2} height="30" viewBox="0 0 512 512" width="30  " xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                      <path d="M255.997,460.351c112.685,0,204.355-91.668,204.355-204.348S368.682,51.648,255.997,51.648  c-112.68,0-204.348,91.676-204.348,204.355S143.317,460.351,255.997,460.351z M255.997,83.888  c94.906,0,172.123,77.209,172.123,172.115c0,94.898-77.217,172.117-172.123,172.117c-94.9,0-172.108-77.219-172.108-172.117  C83.888,161.097,161.096,83.888,255.997,83.888z"/>
                      <path d="M172.077,341.508c3.586,3.523,8.25,5.27,12.903,5.27c4.776,0,9.54-1.84,13.151-5.512l57.865-58.973l57.878,58.973  c3.609,3.672,8.375,5.512,13.146,5.512c4.658,0,9.316-1.746,12.902-5.27c7.264-7.125,7.369-18.793,0.242-26.051l-58.357-59.453  l58.357-59.461c7.127-7.258,7.021-18.92-0.242-26.047c-7.252-7.123-18.914-7.018-26.049,0.24l-57.878,58.971l-57.865-58.971  c-7.135-7.264-18.797-7.363-26.055-0.24c-7.258,7.127-7.369,18.789-0.236,26.047l58.351,59.461l-58.351,59.453  C164.708,322.715,164.819,334.383,172.077,341.508z"/>
                    </svg>
                  </div>
                    <Formik
                      initialValues={{
                        ...
                        <Form>
                          ...
                          <div className={(ToggleState === 1 && (values.city!=="" && values.kolvo!=="" && values.komnati!=="" && values.linkViber!=="" && values.linkWats!=="" && values.linkMail!=="" && values.mail!=="" && values.metro!=="" && values.name!=="" && values.number!=="" && values.ploshad!=="" && values.rayon!=="" && values.sent!=="" && (!errors.sent) && (!errors.ploshad) && (!errors.mail) && (!errors.linkMail) && (imgUrl && imgUrl2)))? "tabs tabs__active":(ToggleState === 1 && (values.city=="" || values.kolvo=="" || values.komnati=="" || values.linkViber=="" || values.linkWats=="" || values.linkMail=="" || values.mail=="" || values.metro=="" || values.name=="" || values.number=="" || values.ploshad=="" || values.rayon=="" || values.sent=="" || (errors.sent) || (errors.ploshad) || (errors.mail) || (errors.linkMail) || (!imgUrl || !imgUrl2)))?"tabs tabs__active tabs__error__active":(ToggleState !== 1 && (values.city=="" || values.kolvo=="" || values.komnati=="" || values.linkViber=="" || values.linkWats=="" || values.linkMail=="" || values.mail=="" || values.metro=="" || values.name=="" || values.number=="" || values.ploshad=="" || values.rayon=="" || values.sent=="" || (errors.sent) || (errors.ploshad) || (errors.mail) || (errors.linkMail) || (!imgUrl || !imgUrl2))?"tabs tabs__error":"tabs" )} onClick={()=>toggleTab(1)} >
                            ...
                            <div className={(ToggleState === 3 && values.opisanie!=="") ? "tabs tabs__active":(ToggleState===3 && values.opisanie=="")?"tabs tabs__active tabs__error__active":(ToggleState!==3 && values.opisanie=="")?"tabs tabs__error":"tabs"} onClick={()=>toggleTab(3)}>
                          ...
                          <div className={ToggleState===1?"delenieObyavlenie":"delenieObyavlenieNone"} style={{marginBottom:"15px"}}>
                            <div className="partOneObyavlenie" style={{marginRight:"15px"}}>
                              ...
                              <Field id="file-input" type="file" onChange={handleOnChange} value={values.url} style={{display:"none"}} />
                            </div>
                          ...
                          <div className="partThreeObyavlenie" style={{marginLeft:"15px"}}>
                            ...
                            <Field id="file-input2" type="file" value={values.imageVladelec} onChange={handleOnChange2} style={{display:"none"}} />
                          </div>
                        </div>
