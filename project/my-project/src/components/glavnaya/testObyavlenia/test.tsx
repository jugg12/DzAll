...
export default function test(){
  ...
  useEffect(()=>{
    ...
    (({data})=>{
      console.log(data.obyavlenia[0])
        setTest(data.obyavlenia[params.id]);
    })
  },[])
  return(
    <>
    ...
    <img className="tochkiJeltie" style={{marginTop:"2%",position:"absolute",left:0,marginLeft:"21%"}} src={img7} alt="" />
        <div className="conteinerKatalogSelect">
          <div className="allInfoStructure">
            <img src={test.url} className="imgKatalogSelect" alt="" />
            <p className="opisanieKatalogSelect">{test.opisanie}</p>
          </div>
        </div>
    </section>
